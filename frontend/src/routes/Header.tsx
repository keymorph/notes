  ...
  return (
    ...
    <div className="contents">
      <div id="link">
       ...
       <a href="#Social TAG">< img src={linkImage} alt=""/> </a>
      </div>

      <div id="donate">
        
        
        <a href="https://www.buymeacoffee.com/FourScript" target= "_blank" rel="noreferrer"> <img src={moneyImage} alt=""/> </a>
      </div>

      <div id="help"> 
        <a href="#Help Link"><img src={helpImage} alt=""/></a>
      </div>
    </div>
